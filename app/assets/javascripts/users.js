...
// (namely, the user JSON object has a "routines" key that points to an array of routine objects)
...
// but the JSON response ALSO includes nested data about the associated pieces of equipment, target areas and training types 
...
User.loadClientWorkouts = function(userObject) {
  ...
  $userRoutinesDiv.append(`<h4><strong>Workout Routines Designed by ${userObject.name}</strong></h4>`)
